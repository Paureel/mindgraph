    ...
    with app.app_context():
        ...
        try:
            ...
            edge_types = [
                ...
                'Expert in', 'Competes with', 'Belongs to', 'Interacts with', 'Syntheticaly lethal', 'Affects'
            ]
            result = {
